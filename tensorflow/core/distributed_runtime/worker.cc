...
void Worker::GetRemoteAddressAsync(const GetRemoteAddressRequest* request, 
...
#else
    // should not be here if RDMA is not selected.
    done(errors::Unimplemented("Worker::GetRemoteAddressAsync()"));
#endif
  }
