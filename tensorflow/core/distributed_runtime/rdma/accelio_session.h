...
#ifndef THIRD_PARTY_TENSORFLOW_CORE_DISTRIBUTED_RUNTIME_RPC_Accelio_SESSION_H_
#define THIRD_PARTY_TENSORFLOW_CORE_DISTRIBUTED_RUNTIME_RPC_Accelio_SESSION_H_
...
// wrapper around tensorflow::Accelio::MasterService.
//
// Multiple threads must synchronize their accesses to a single
// session.
class AccelioSession : public Session {
 protected:
  explicit AccelioSession(const SessionOptions& options);
 ...
 private:
  ...
  TF_DISALLOW_COPY_AND_ASSIGN(AccelioSession);
};

}  // namespace tensorflow

#endif  // THIRD_PARTY_TENSORFLOW_CORE_DISTRIBUTED_RUNTIME_RPC_Accelio_SESSION_H_
