...
#ifndef THIRD_PARTY_TENSORFLOW_CORE_DISTRIBUTED_RUNTIME_RPC_Accelio_SERVER_LIB_H_
#define THIRD_PARTY_TENSORFLOW_CORE_DISTRIBUTED_RUNTIME_RPC_Accelio_SERVER_LIB_H_
...
class AccelioServer : public ServerInterface {
 protected:
  AccelioServer(const ServerDef& server_def, Env* env);
 ...
 protected:
  ...
  virtual std::shared_ptr<::Accelio::ServerCredentials> GetServerCredentials(
 ...
 private:
  ...
  std::unique_ptr<::Accelio::Server> server_ GUARDED_BY(mu_);
};

}  // namespace tensorflow

#endif  // THIRD_PARTY_TENSORFLOW_CORE_DISTRIBUTED_RUNTIME_RPC_Accelio_SERVER_LIB_H_
